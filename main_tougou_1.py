...
def game_loop():
    ...
    running = True
    timer = 0
    prev_detected = False  # 立ち上がり攻撃用の状態保存変数
    ...
    while running:
        ...
        # カメラコントローラーの更新と画像変換
        # =================================================
        is_detected, pos, element, action, speed_state, debug_frame = (False, None, None, None, "walk", None)
        cam_surface = None  # カメラ画像を保存する変数
